...
export default function Login() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      login(res.data.token);   // store the JWT via context
  ...
  return (
    <AuthShell title="Welcome back" subtitle="Sign in to see your board.">
      ...
      <button onClick={handleSubmit} style={{ ...bigAction, background: C.clay, color: C.bone, border: "none", width: "100%", justifyContent: "center", marginTop: 6 }}>Sign in</button>
...
export function AuthShell({ title, subtitle, children }) {
  return (
    <div style={{ minHeight: "100vh", display: "grid", gridTemplateColumns: "1.05fr 0.95fr", background: C.base }}>
      <div style={{ background: C.panel, color: C.bone, padding: "56px 60px", display: "flex", flexDirection: "column", justifyContent: "space-between", position: "relative", overflow: "hidden", borderRight: "1px solid " + C.line }}>
